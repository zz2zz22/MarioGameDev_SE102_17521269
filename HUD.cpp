...
void HUD::_ParseLives() {
	_lives.clear();
	std::vector<unsigned int> digits = GameUtils::SplitDigit(_player->_lives);
...
void HUD::_ParseCoins() {
	_coins.clear();
	std::vector<unsigned int> digits = GameUtils::SplitDigit(_player->_coins);
...
void HUD::_ParseScore() {
	_score.clear();
	std::vector<unsigned int> digits = GameUtils::SplitDigit(_player->_score);
...
void HUD::_ParseTimeLeft(DWORD sceneTime) {
	_timeLeft.clear();
	std::vector<unsigned int> digits = GameUtils::SplitDigit(sceneTime);
